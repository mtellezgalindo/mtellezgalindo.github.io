                    ...
                    <div className="featured-post-right">
                        <div className="content-text">
                            <div className="animate-element wow delay5 fadeInDown" data-wow-delay="0.3s">
                                <div className="tag lt-sp53 mg-b24 text-white">FullStack Developer</div>                                    
                                <h1 className="cd-headline clip is-full-width title mg-b29 text-white">
                                <span>Hello, </span>
                                <span className="cd-words-wrapper color-d4">
                                    <b className="is-visible">I’m Martin!</b>
                                    
                                </span>
                                </h1>
                                <p className="mg-b53 text-white">
                               
                                Fullstack developer for 10 years. Working in important companies for Mexico.<br/>

                                I am always learning to move forward, and grow as a professional in what I am most passionate <br/>

                                My goal is to be able to work in global companies, and have my work recognized <br/>
